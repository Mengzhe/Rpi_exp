...
import numpy as np
memory_00 = np.load('sars_tuple_for_all_trials_00_0719.npy')
memory_01 = np.load('sars_tuple_for_all_trials_01_0719.npy')
memory = np.vstack((memory_00,memory_01))
# state 1: distance to center; state 2: curvature
dim_state = 2
dim_action = 5
#w_old = np.load('learned_weights_w_01_0719.npy')
...
np.save('learned_weights_w_02_0719', w_new)
np.save('learned_weights_history_02_0719', w_hist)